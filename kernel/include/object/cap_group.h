...
struct object_slot {
        u64 slot_id;
        // the process this slot belongs to.
        // a reverse index.
...
// every cap_group should be regarded as a process.
struct cap_group {
        // two main slots:cap_group itself(0), vmspace(1)
        // As we have thread in Chcore, stack should be contained by structure thread.
        struct slot_table slot_table;
        // threads realted to this process.
