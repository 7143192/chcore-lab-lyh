                 ...
                 int type)
{
        ...
        // consider the casr that concurrent threads visit one same slot.
...
int sys_create_cap_group(u64 pid, u64 cap_group_name, u64 name_len, u64 pcid)
{
        ...
        // allocate new cap group as a new obj.
        ...
        /* 2st cap is vmspace */
        /* LAB 3 TODO BEGIN */
        // allocate a new object as a new vmspace.
